    ...
    <div class="carousel-frame">
      ...
      <div class="carousel-viewport" ref="viewport">
        <div class="carousel-track" :style="trackStyle" ref="track">
          <div class="slide" v-for="(img, idx) in extendedImages" :key="idx">
...
export default {
  ...
  computed: {
    ...
    trackStyle() {
      ...
      const width = this.extendedImages.length * this.slideWidth;
  ...
  methods: {
    ...
    computeSlideWidth() {
      this.$nextTick(() => {
        ...
        this.slideWidth = Math.floor(vw / this.imagesPerView);
      });
    },
    prev() {
      if (!this.images.length) return;
